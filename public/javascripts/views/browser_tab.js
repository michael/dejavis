var BrowserTab = Backbone.View.extend({
  events: {
    'submit #search_form': 'loadProjects',
  ...
  render: function() {
    ...
    if (this.browser.query) {
      switch (this.browser.query.type){
        case 'user': queryDescr = this.browser.query.value+"'s projects"; break;
        case 'recent': queryDescr = 'Recent Projects'; break;
        default : queryDescr = 'Projects for &quot;'+this.browser.query.value+'&quot;';
      }
    } else {
    ...
    $(this.el).html(_.tpl('browser_tab', {
      projects: this.browser.projects,
